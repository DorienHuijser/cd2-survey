...
```{r parameters}
# Files to be read in
datafile <- "../data/raw/CD2_vocabularies_20220324.csv"
...
# Combine all cohorts in 1 file
results_all <- rbind(results_TRAILS,results_GenR, results_RADAR, results_LCID, results_YOUth, results_NTR)
